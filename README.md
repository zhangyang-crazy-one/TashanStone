...
|:---:|:---:|
| Windows x64 | [TashanStone-Setup-1.7.8-x64.exe](https://github.com/tashanstone/tashanstone/releases/download/v1.7.8/TashanStone-Setup-1.7.8-x64.exe) |
| macOS (Intel / Apple Silicon) | [📖 查看编译指南 / Build Guide](docs/BUILD_MAC.md) |
| Linux x64 (Debian/Ubuntu/麒麟) | [tashanstone_1.7.8_amd64.deb](https://github.com/tashanstone/tashanstone/releases/download/v1.7.8/tashanstone_1.7.8_amd64.deb) |
| Linux AppImage | [TashanStone-1.7.8.AppImage](https://github.com/tashanstone/tashanstone/releases/download/v1.7.8/TashanStone-1.7.8.AppImage) |
...
1. **下载安装**
   ...
   - Linux: 下载 `.deb` 包，运行 `sudo dpkg -i tashanstone_1.7.8_amd64.deb`
