...
- Usage: Reference from command with `@/home/zhangyangrui/my_programes/TashanStone/.codex/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/zhangyangrui/my_programes/TashanStone/.codex/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/zhangyangrui/my_programes/TashanStone/.codex/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
