...
- **Global scope**: `/home/zhangyangrui/my_programes/TashanStone/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/zhangyangrui/my_programes/TashanStone/.codex/notes/`)
...
2. Glob `/home/zhangyangrui/my_programes/TashanStone/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/home/zhangyangrui/my_programes/TashanStone/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/zhangyangrui/my_programes/TashanStone/.codex/notes/` — works in any directory
