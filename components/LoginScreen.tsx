...
export const LoginScreen: React.FC<LoginScreenProps> = ({ onLogin, showConfirmDialog }) => {
                            ...
                            <button
                                onClick={() => {
                                    ...
                                    if (showConfirmDialog) {
                                        showConfirmDialog(
                                            'Factory Reset',
                                            'WARNING: This action will permanently erase all local data and reset the system. Proceed?',
                                            factoryReset,
                                            'danger',
                                            'Reset All Data',
                                            'Cancel'
