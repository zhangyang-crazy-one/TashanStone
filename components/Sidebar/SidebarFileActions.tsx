  ...
  return (
    <div className="grid grid-cols-2 gap-2 mb-3">
      ...
      <button
        ...
        className="flex items-center justify-center gap-1.5 px-3 py-2 bg-white dark:bg-cyber-900 border border-paper-200 dark:border-cyber-700 rounded-lg text-slate-600 dark:text-slate-300 hover:border-cyan-400 transition-colors text-xs font-medium"
      >
      ...
      <button
        ...
        className="flex items-center justify-center gap-1.5 px-3 py-2 bg-slate-200 dark:bg-cyber-900 hover:bg-slate-300 dark:hover:bg-cyber-700 text-slate-700 dark:text-slate-300 rounded-lg transition-colors text-xs font-medium"
      >
      ...
      <button
        ...
        className="col-span-2 flex items-center justify-center gap-1.5 px-3 py-2 bg-white dark:bg-cyber-900 border border-paper-200 dark:border-cyber-700 rounded-lg text-slate-600 dark:text-slate-300 hover:border-violet-400 transition-colors text-xs font-medium"
      >
