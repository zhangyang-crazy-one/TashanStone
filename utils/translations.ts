...
export const translations = {
  en: {
    ...
    expand: "Expand",
    mindMap: "Mind Map",
    mindMapDetailLevel: "Mind Map Detail",
    mindMapDetailCompact: "Compact",
    mindMapDetailDetailed: "Detailed",
    mindMapDetailHint: "Detailed adds summaries to nodes.",
    quiz: "Quiz",
    chat: "AI Chat",
    settings: "Settings",
    editor: "Editor",
    ...
    chatContext: {
      ...
      workspaceContextHint: "Review which notes and highlighted text will be injected before you send.",
      activeNote: "Active note",
      noActiveNote: "No active note",
      scope: "Scope",
      focusedNoteOnly: "Focused note only",
      openPanes: "Open panes",
      includeHighlightedText: "Include highlighted text",
      selectedText: "Selected text",
      noHighlightedText: "No highlighted text",
      highlightedTextIncluded: "Selected text will be included",
      highlightedTextExcluded: "Selected text is available but excluded",
    ...
    chatRuntime: {
      ...
      toggleAriaLabel: "Live runtime details",
      subtitle: "Read-only visibility into phase, streaming deltas, and assembled context.",
      ...
      deltaCountShort: "deltas",
      noLastDelta: "No streamed delta yet.",
      notAvailable: "n/a",
    ...
    assistantSettings: {
      ...
      operator: {
        sections: {
          ...
          plugins: { title: 'Plugins', help: 'Extension sources, approval flow, and sandbox boundaries for operator-installed plugins.' },
          skills: { title: 'Skills', help: 'Skill registry, project skill sources, and workflow capabilities available to agents.' },
  ...
  zh: {
    ...
    expand: "扩写",
    mindMap: "思维导图",
    mindMapDetailLevel: "思维导图细节",
    mindMapDetailCompact: "简洁",
    mindMapDetailDetailed: "详细",
    mindMapDetailHint: "详细模式会在节点显示摘要。",
    quiz: "生成测验",
    chat: "AI 对话",
    settings: "设置",
    editor: "编辑",
    ...
    chatContext: {
      ...
      workspaceContextHint: "在发送前确认将注入的笔记范围和高亮文本。",
      activeNote: "当前笔记",
      noActiveNote: "没有当前笔记",
      scope: "范围",
      focusedNoteOnly: "仅当前笔记",
      openPanes: "打开的面板",
      includeHighlightedText: "包含高亮文本",
      selectedText: "已选文本",
      noHighlightedText: "没有高亮文本",
      highlightedTextIncluded: "将注入已选文本",
    ...
    chatRuntime: {
      liveRuntime: "实时运行",
      runtimeDetails: "运行详情",
      toggleAriaLabel: "实时运行详情",
      subtitle: "只读显示当前阶段、流式增量和上下文装配情况。",
      idle: "尚未产生运行时活动。",
      idleLabel: "空闲",
      requestId: "请求",
      sessionId: "会话",
    ...
    assistantSettings: {
      ...
      operator: {
        sections: {
          ...
          plugins: { title: '插件', help: '供操作员安装的插件扩展来源、审批流程与沙箱边界。' },
