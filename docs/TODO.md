...
| 子任务 | 描述 | 状态 |
|--------|------|------|
| [ ] 1.1 类型定义 | 扩展 ApiMessage、定义 TokenUsage、ContextConfig 等接口 | 待开始 |
| [ ] 1.2 上下文管理器 | 实现 ContextManager 类，Token 计算、使用率分析、触发决策 | 待开始 |
| [ ] 1.3 Prune 算法 | 实现工具输出裁剪，保护最近对话 | 待开始 |
| [ ] 1.4 Compact 算法 | 实现 LLM 摘要生成，非破坏性标记 | 待开始 |
| [ ] 1.5 Truncate 算法 | 实现滑动窗口截断 | 待开始 |
| [ ] 1.6 Token 预算管理 | 实现动态预算分配、阈值检查 | 待开始 |
