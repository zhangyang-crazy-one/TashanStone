...
| 子任务 | 描述 | 状态 |
|--------|------|------|
| [ ] 4.1 Token 使用率 | TokenUsageIndicator 组件 | 🔜 待开始 |
| [ ] 4.2 上下文状态 | ContextActionBadge 组件 | 🔜 待开始 |
| [ ] 4.3 压缩按钮 | CompactButton 组件 | 🔜 待开始 |
| [ ] 4.4 检查点面板 | CheckpointDrawer 组件 | 🔜 待开始 |
| [ ] 4.5 AI 设置 | 上下文工程配置区 | 🔜 待开始 |
